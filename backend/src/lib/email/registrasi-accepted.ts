export function registrasiAcceptedEmail(
  nama: string,
  linkWeb: string,
  role: "ota" | "ma",
) {
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix shadow"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="font-size:0px;padding:25px 25px 0 25px;word-break:break-word;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td align="left"
                                            ...
                                            <div
                                              style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:24px;text-align:justify;color:#003A6E;">
                                              Halo <b>${nama}</b>, Akun ${role == "ota" ? "Orang Tua Asuh" : "Mahasiswa Asuh"} Anda sudah berhasil
                                              terverifikasi. Anda sekarang sudah dapat melakukan pemilihan Mahasiswa
                                              Asuh sekarang.</div>
                                        ...
                                        <tr>
                                          <td align="left"
                                            ...
                                            <div
                                              style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:24px;text-align:left;color:#8898aa;">
                                            </div>
