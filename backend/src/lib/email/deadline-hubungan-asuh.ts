export function deadlineHubunganAsuhEmail(
  nama: string,
  nama_ma: string,
  jurusan: string,
  semester: string,
                                          ...
                                          <tr>
                                            ...
                                            >
                                              <div
                                                ...
                                                "
                                              >
                                                Pemberitahuann Masa Akhir Asuh
                                              </div>
                                            </td>
                                          </tr>
                                        </tbody>
                                          ...
                                          <tr>
                                            ...
                                            >
                                              <div
                                                ...
                                                "
                                              >
                                                Halo <b>${nama}</b>, Hubungan
                                                Asuh Anda dengan <b>
                                                  ${nama_ma}</b
                                                >
                                                akan berakhir. Dengan detail:
                                                <ul>
                                                  <li>
                                                    Nama :
                                                    <strong> ${nama_ma}</strong>
                                                  </li>
                                                  <li>
                                                    Jurusan :
