                                        ...
                                        <tr>
                                          <td align="center"
                                            ...
                                            <div
                                              ...
                                              Notifikasi Tenggat Waktu Pembayaran</div>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td align="left"
                                            ...
                                            <div
                                              style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:24px;text-align:left;color:#003A6E;">
                                              <div style="text-align:justify;">Menginformasikan untuk segera melakukan
                                                transaksi Bantuan Orang Tua Asuh sebesar <b>Rp${besar_tagihan.toLocaleString("id-ID")}</b> terakhir
                                                pada <b>${tanggal}.</b></div>
                                            </div>
                                        ...
                                        <tr>
                                          <td align="left"
                                            ...
                                            <div
                                              style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:500;line-height:24px;text-align:left;color:#003A6E;">
                                              <div style="text-align:center;">Tenggat Waktu Pembayaran</div>
                                            </div>
                                        ...
                                        <tr>
                                          <td style="font-size:0px;padding:10px;word-break:break-word;">
                                            ...
                                            <div
                                              style="background:#f5f5f5;background-color:#f5f5f5;margin:0px auto;border-radius:8px 8px 8px 8px;max-width:510px;">

                                              <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                role="presentation"
                                                style="background:#f5f5f5;background-color:#f5f5f5;width:100%;border-radius:8px 8px 8px 8px;">
                                                <tbody>
                                                  <tr>
                                                    <td
                                                          ...
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td align="center"
                                                                ...
                                                                <div
                                                                  style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:1.5rem;font-weight:700;line-height:24px;text-align:center;color:#003A6E;">
                                                                  ${tanggal}</div>
                                                            ...
                                                            <tr>
                                                              <td align="center"
                                                                ...
                                                                <div
                                                                  style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:1rem;font-weight:400;line-height:24px;text-align:center;color:#003A6E;">
                                                                  ${sisa_hari} Hari Lagi</div>
                                        ...
                                        <tr>
                                          <td align="left"
                                            style="font-size:0px;padding:16px 0px 10px 0px;word-break:break-word;">
