export function penjodohanOlehAdminEmail(nama: string, mahasiswa: string[]) {
  return `<!doctype html>
                                        ...
                                        <tr>
                                          <td align="left"
                                            ...
                                            <div
                                              ...
                                              Halo <b>${nama}</b>, Admin IOM telah memilihkan Mahasiswa Asuh yang akan
                                              menerima Bantuan dari Anda<ul>
                                                <li>
                                                  <div style="font-weight:700;">[Nama Mahasiswa]</div>
                                                </li>
                                                ${mahasiswa.map((siswa) => "<li > <strong> " + { siswa } + "</strong> </li>")}
